...
book_infor static_book_list[BOOK_LAST]=
{
	...
	book_infor("파괴의 마법책",true,BOOK_CONJURE,700,SPL_MAGIC_TANMAC,SPL_SUMMON_OPTION,SPL_LASER,SPL_FIRE_BOLT,SPL_ICE_BOLT,SPL_SUMMON_ELEC_BALL,SPL_NONE,SPL_NONE),
