...
book_infor static_book_list[BOOK_LAST]=
{
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_ALCHMY_ULTI,BOOK_ALCHMY_ULTI,1500,SPL_ELEMENTAL_HARVESTER,SPL_STONE_FORM,SPL_AUTUMN_BLADE,SPL_PHILOSOPHERS_STONE, SPL_NONE,SPL_NONE,SPL_NONE,SPL_NONE),
