...
book_infor static_book_list[BOOK_LAST]=
{
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_BRAND_BASE,BOOK_BRAND_BASE,400,SPL_VEILING,SPL_DIAMOND_HARDNESS,SPL_POISON_SKIN,SPL_SILENCE,SPL_NONE,SPL_NONE,SPL_NONE,SPL_NONE),
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_STALKING,BOOK_STALKING,600,SPL_STING,SPL_CONFUSE,SPL_CONFUSE_CLOUD,SPL_NIGHTMARE_MANIFEST,SPL_NONE,SPL_NONE,SPL_NONE,SPL_NONE),
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_DEBUF,BOOK_DEBUF,1500,SPL_ANIMAL_CHANGE,SPL_PRIVATE_SQ,SPL_NIGHTMARE_MANIFEST,SPL_FIELD_VIOLET,SPL_NONE,SPL_NONE,SPL_NONE,SPL_NONE),
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_ALCHMY_ULTI,BOOK_ALCHMY_ULTI,1500,SPL_ELEMENTAL_HARVESTER,SPL_STONE_FORM,SPL_AUTUMN_BLADE,SPL_ROYALFLARE, SPL_PHILOSOPHERS_STONE,SPL_NONE,SPL_NONE,SPL_NONE),
	...
	book_infor(LOC_SYSTEM_ITEM_BOOK_FIRE_EXTEND,BOOK_FIRE_EXTEND,600,SPL_FIRE_BALL,SPL_FIRE_BOLT,SPL_ROYALFLARE,SPL_NONE, SPL_NONE,SPL_NONE,SPL_NONE,SPL_NONE)
};
...
string GetBookInfor(book_list book_)
{
	...
	case BOOK_FIRE_EXTEND:
		return LocalzationManager::locString(LOC_SYSTEM_ITEM_DESCRIPTION_BOOK_FIRE_EXTEND);
	}
}
...
book_list GetRandomBook(int good_) {
	...
	for(int i = 0; i < BOOK_LAST; i++) {
		bool isRare = isRareBook((book_list)i);
		if(!(good_ == -1 && isRare)) {
			rand_.push(i, isRare?1:3);
		}
	}
	return (book_list)rand_.pop();
}
	...
	case SKT_FIRE:
		{
			...
			list_.push(BOOK_FIRE_EXTEND,10);
			list_.push(BOOK_ENCHANT,2);
			return list_.pop();
		}
	case SKT_COLD:
