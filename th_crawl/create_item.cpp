...
item_group item_index[] = //아이템 목록(꼭 2번째를 내림차순으로 정렬)
{
	...
	{26,SUBTERRANEAN_LEVEL,SUBTERRANEAN_LEVEL_LAST_LEVEL,10,1}, //스펠카드
	...
	{26,DEPTH_LEVEL,DEPTH_LAST_LEVEL,15,1}, //스펠카드
	{21,DEPTH_LEVEL,DEPTH_LAST_LEVEL,5,1}, //음식
	{22,DEPTH_LEVEL,DEPTH_LAST_LEVEL,5,1}, //중반용 방패
