...
void start_mainmenu()
{
	...
	while (retry_) {
		...
		joblist_struct joblist[22] = {
			...
			{JOB_GLADIATOR, LOC_SYSTEM_JOB_GLADIATOR,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_GLADIATOR},
			{JOB_MONK, LOC_SYSTEM_JOB_MONK,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_MONK},
			{JOB_CRUSADER, LOC_SYSTEM_JOB_CRUSADER,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_CRUSADER},
			{JOB_BERSERKER, LOC_SYSTEM_JOB_BERSERKER,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_BERSERKER},
			{JOB_FIRE_WIZARD, LOC_SYSTEM_JOB_FIRE_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_FIRE_WIZARD},
			{JOB_COLD_WIZARD, LOC_SYSTEM_JOB_COLD_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_COLD_WIZARD},
			{JOB_EARTH_WIZARD, LOC_SYSTEM_JOB_EARTH_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_EARTH_WIZARD},
			{JOB_AIR_WIZARD, LOC_SYSTEM_JOB_AIR_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_AIR_WIZARD},
			{JOB_LIGHT_WIZARD, LOC_SYSTEM_JOB_LIGHT_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_LIGHT_WIZARD},
			{JOB_SUMMON_WIZARD, LOC_SYSTEM_JOB_SUMMON_WIZARD,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_SUMMON_WIZARD},
			{JOB_ALCHEMIST, LOC_SYSTEM_JOB_ALCHEMIST,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_ALCHEMIST},
			{JOB_PSYCHOLOGIST, LOC_SYSTEM_JOB_PSYCHOLOGIST,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_PSYCHOLOGIST},
			{JOB_REAPER, LOC_SYSTEM_JOB_REAPER,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_REAPER},
			{JOB_FANATIC, LOC_SYSTEM_JOB_FANATIC,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_FANATIC},
			{JOB_ASSASSIN, LOC_SYSTEM_JOB_ASSASSIN,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_ASSASSIN},
			{JOB_FARMER, LOC_SYSTEM_JOB_FARMER,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_FARMER},
			{JOB_MADE, LOC_SYSTEM_JOB_MADE,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_MADE},
			{JOB_ENGINEER, LOC_SYSTEM_JOB_ENGINEER,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_ENGINEER},
			{JOB_MISSING, LOC_SYSTEM_JOB_MISSING,LOC_SYSTEM_MAINMENU_MAINGAME_JOB_MISSING}
		};
		...
		for (int i = 0; i < 21; i++) {
			...
			tempstr += ": ";
			tempstr += LocalzationManager::locString(joblist[i].infor);
			tempstr += "\n\n\n";
			tempstr += LocalzationManager::locString(LOC_SYSTEM_MAINMENU_CONTINUE_SAMEKEY);
			tempstr += "\n";
			m_mgr.menu_input_puls(4,hotkey_,5,tempstr,true,select_job,joblist[i].type);
			m_mgr.menu_input_puls(4,hotkey_+ 'A'-'a',4,"",false,show_help,joblist[i].type+1+max_tribe);
		...
		LOCALIZATION_ENUM_KEY fariylist[3][3] = {
			{LOC_SYSTEM_TRIBE_FAIRY,LOC_SYSTEM_JOB_LIGHT_WIZARD,LOC_SYSTEM_PLAYER_SUNNY},
