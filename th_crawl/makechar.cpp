...
void MakeStartItem(start_item_type select_, int num)
{
	...
	case SIT_BROOM:
		...
		break;
	case SIT_ROBE:
		it = env[current_level].MakeItem(you.position,CustomItem(&t,ITM_ARMOR_BODY_ROBE,&img_item_armor_robe,1,false,false,armour_stat[0][0],armour_stat[0][1],armour_stat[0][2],0,0,0,0,0,false,name_infor("무녀복",true),name_infor("",true),6.0f,40));
		(*it).identify = true;
		(*it).identify_curse = true;
		you.additem(it,false);
	...
	case SIT_ARMOUR_1:
		...
		break;
	case SIT_ARMOUR_2:
		it = env[current_level].MakeItem(you.position,CustomItem(&t,ITM_ARMOR_BODY_ARMOUR_2,&img_item_armor_armour_2,1,false,false,armour_stat[3][0],armour_stat[3][1],armour_stat[3][2],0,0,0,0,0,false,name_infor("두꺼운 중갑옷",true),name_infor("",true),6.0f,40));
		(*it).identify = true;
		(*it).identify_curse = true;
		you.additem(it,false);
		you.equiparmor('a'+num,false);
