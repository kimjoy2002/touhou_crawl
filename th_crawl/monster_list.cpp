...
const mon_infor mondata[] = {
	...
	{MON_MEDICINE,9,1066,name_infor("메디슨",true),&img_named_medicine,75,2,10,
	...
	{MON_KYOUKO,6,500,name_infor("쿄코",false),&img_named_kyouko,30,1,11,
	{5,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	...
	{MON_MOMIZI,12,1923,name_infor("모미지",false),&img_named_momizi,142,12,2,
	...
	{MON_AYA,15,3421,name_infor("아야",false),&img_named_aya,118,1,14,
	{15,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	//여기부터 임시 정보들
	{MON_WAKASAGI,7,300,name_infor("와카사기히메",false),&img_named_wakasagi,50,0,15,
	{10,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SWIM | M_FLAG_CANT_NETURAL | M_FLAG_SPEAK | M_FLAG_CANT_GROUND,0,1,10,'&' },

	{MON_YAMAME,8,854,name_infor("야마메",false),&img_named_yamame,95,3,11,
	{15,16,28},{ATT_NORMAL,ATT_NONE,ATT_SICK},{name_infor("공격",true),name_infor("공격",true),name_infor("독기",false)},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	
	{MON_NAZRIN,7,570,name_infor("나즈린",true),&img_named_nazrin,45,0,10,
	...
	{MON_YOSIKA,9,0,name_infor("요시카",false),&img_named_yosika,150,3,3,
	...
	{MON_SEKIBANKI,8,824,name_infor("세키반키",false),&img_named_sekibanki,78,3,9,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK | M_FLAG_CAN_SEE_INVI,1,1,10,'&' },
	
	{MON_SEKIBANKI_BODY,8,824,name_infor("세키반키",false),&img_named_sekibanki_body,78,10,0,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_NITORI,13,2188,name_infor("니토리",false),&img_named_nitori,105,8,12,
	...
	{MON_KEGERO,10,1297,name_infor("카게로",false),&img_named_kagero,130,3,12,
	{36,25,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("물기",false),name_infor("할퀴기",false),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	
	{MON_PARSI,9,925,name_infor("파르시",false),&img_named_parsi,130,8,15,
	{25,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	
	{MON_BENBEN,6,520,name_infor("벤벤",true),&img_named_benben,67,3,3,
	{12,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK | M_FLAG_FLY | M_FLAG_NONE_STAIR,2,1,10,'&' },
	
	{MON_YATHASI,6,520,name_infor("야츠하시",false),&img_named_yathasi,58,0,8,
	{12,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK | M_FLAG_FLY | M_FLAG_NONE_STAIR,2,1,10,'&' },
	
	{MON_ORIN,13,2310,name_infor("오린",true),&img_named_orin,115,1,12,
	{29,0,0},{ATT_FIRE,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,2,1,10,'&' },
	
	{MON_ORIN_CAT,13,2310,name_infor("오린",true),&img_named_orin_cat,70,0,25,
	...
	{MON_ICHIRIN,13,3240,name_infor("이치린",true),&img_named_ichirin,128,9,2,
	{18,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	...
	{MON_PACHU,13,1923,name_infor("파츄리",false),&img_named_pachu,70,1,5,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_KOAKUMA,11,1615,name_infor("소악마",false),&img_named_koakuma,68,1,8,
	{10,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK | M_FLAG_FLY,2,1,10,'&' },
	
	{MON_MEIRIN,8,850,name_infor("홍메이린",true),&img_named_meirin,105,8,6,
	...
	{MON_SAKUYA,13,3072,name_infor("사쿠야",false),&img_named_sakuya,130,1,20,
	...
	{MON_REMILIA,15,4521,name_infor("레밀리아",false),&img_named_remilia,200,1,22,
	{34,24,0},{ATT_VAMP,ATT_NONE,ATT_NONE},{name_infor("흡혈",true),name_infor("공격",true),name_infor()},
	...
	{MON_KASEN,16,5872,name_infor("카센",true),&img_named_kasen,210,7,6,
	...
	{MON_KOISHI,13,3880,name_infor("코이시",false),&img_named_koishi,75,3,18,
	{15,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{25,0,0},{ATT_COLD,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_CAN_SEE_INVI | M_FLAG_SPEAK | M_FLAG_FLY,2,1,10,'1' },
	{MON_YUMEKO,19,5672,name_infor("유메코",false),&img_mons_yumeko,350,3,18,
	...
	{MON_TEWI,13,2150,name_infor("테위",false),&img_named_tewi,70,3,22,
	{12,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_NIGHTMARE,15,1712,name_infor("악몽의 조각",true),&img_mons_nightmare,112,12,5,
	...
	{MON_HELL_HOUND,9,512,name_infor("지옥개",false),&img_mons_hell_dog,68,4,15,
	...
	{MON_EVIL_EYE_TANK,28,5043,name_infor("이블 아이 전차",false),&img_mons_evil_eye_tank,130,20,10,
	{0,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_LETTY,14,1832,name_infor("레티",false),&img_named_letty,150,11,6,
	...
	{52,52,0},{ ATT_FIRE,ATT_ELEC,ATT_NONE},{name_infor("화염검",true),name_infor("번개검",true),name_infor()},
	...
	{MON_RINGO,13,1585,name_infor("링고",false),&img_named_ringo,110,14,6,
	...
	{MON_UDONGE,15,1973,name_infor("레이센",true),&img_named_udonge,150,4,16,
	{30,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_FAKE_SANGHAI,10,1,name_infor("모조 상해 인형",true),&img_mons_sanghai[1],60,5,17,
	{25,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_CAN_SEE_INVI | M_FLAG_PASSED_ALLY | M_FLAG_CANT_NETURAL | M_FLAG_INANIMATE,99,1,7,'d' },
	
	{MON_FAKE_HOURAI,10,1,name_infor("모조 봉래 인형",true),&img_mons_hourai[1],90,15,2,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_NO_ATK | M_FLAG_OPEN_DOOR | M_FLAG_CAN_SEE_INVI | M_FLAG_LEADER_SUMMON | M_FLAG_PASSED_ALLY | M_FLAG_CANT_NETURAL | M_FLAG_INANIMATE,99,1,10,'d' },
	
	{MON_TOKIKO,11,1205,name_infor("책읽는 요괴",false),&img_mons_tokiko,112,1,15,
	{16,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_FLY | M_FLAG_SPEAK,1,1,10,'&' },

	
	{MON_TOZIKO,15,3905,name_infor("토지코",false),&img_mons_toziko,135,5,15,
	...
	{MON_FUTO,16,4605,name_infor("후토",false),&img_mons_futo,145,1,20,
	...
	{MON_SEIGA,17,6205,name_infor("세이가",false),&img_mons_seiga,170,12,10,
	{25,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{ MON_MURASA,17, 6510,name_infor("무라사",false),&img_named_murasa,180,5,15,
	{ 22,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_SWIM | M_FLAG_SPEAK,2,1,10,'&' },

	{ MON_KEINE,15,4212,name_infor("케이네",false),&img_named_keine,150,12,5,
	{ 14,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_SPEAK,3,3,10,'&' },

	{ MON_KEINE2,15,4212,name_infor("백택 케이네",false),&img_named_keine2,150,0,18,
	...
	{ MON_LYRICA,13,1624,name_infor("리리카",false),&img_named_lyrica,72,1,15,
	{ 16,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_NONE_STAIR | M_FLAG_FLY | M_FLAG_SPEAK,3,1,10,'&' },

	//메를랑과 루나사는 디버프를 위한 HD 보정
	{ MON_MERLIN,16,1642,name_infor("메를랑",true),&img_named_merlin,75,5,5,
	{ 12,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_NONE_STAIR | M_FLAG_FLY | M_FLAG_SPEAK,3,1,10,'&' },

	{ MON_LUNASA,17,1890,name_infor("루나사",false),&img_named_lunasa,85,2,10,
	{ 15,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_NONE_STAIR | M_FLAG_FLY | M_FLAG_SPEAK,3,1,10,'&' },

	{ MON_KOMACHI,21,9218,name_infor("코마치",false),&img_named_komachi,310,15,3,
	{ 42,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("낫",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_SPEAK,2,0,13,'&' },

	{ MON_IKU,15,4162,name_infor("이쿠",false),&img_named_iku,115,10,20,
	...
	{ MON_NEMUNO,10,1221,name_infor("네무노",false),&img_named_nemuno,105,15,2,
	{ 18,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("칼",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10,'&' },
	...
	{ MON_KOKORO,17,1,name_infor("코코로",false),&img_named_kokoro[0],190,9,12,
	{ 20,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_FLY | M_FLAG_SPEAK,2,1,10,'&' },

	{ MON_KOKORO1,17,1,name_infor("코코로",false),&img_named_kokoro[1],190,9,12,
	{ 30,0,0 },{ ATT_FIRE,ATT_NONE,ATT_NONE },{ name_infor("부채",false),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_FLY | M_FLAG_SPEAK,2,1,10,'&' },

	{ MON_KOKORO2,17,1,name_infor("코코로",false),&img_named_kokoro[2],190,9,12,
	{ 30,0,0 },{ ATT_COLD,ATT_NONE,ATT_NONE },{ name_infor("부채",false),name_infor(),name_infor() },
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_CAN_SEE_INVI | M_FLAG_FLY | M_FLAG_SPEAK,2,1,10,'&' },

	{ MON_KOKORO3,17,1,name_infor("코코로",false),&img_named_kokoro[3],190,9,12,
	...
	{ MON_HATATE, 10, 1221, name_infor("하타테", false), &img_named_hatate, 85, 2, 22,
		{ 7,0,0 },{ ATT_NORMAL,ATT_NONE,ATT_NONE },{ name_infor("공격",true),name_infor(),name_infor() },
	...
	{ MON_DOREKING, 30, 9999, name_infor("도레킹", true), &img_named_doreking, 500, 22, 10,
	{ 40,0,0 }, { ATT_NORMAL,ATT_NONE,ATT_NONE }, { name_infor("공격",true),name_infor(),name_infor() },
	...
	{MON_KAGUYA_QUIZ_0, 12, 1, name_infor("용목의 구슬", true), &img_mon_kaguya_quiz[0], 10, 0, 5,
	{ 0,0,0 }, { ATT_NONE,ATT_NONE,ATT_NONE }, { name_infor(),name_infor(),name_infor() },
	...
	{ MON_KAGUYA_QUIZ_1, 12, 1, name_infor("부처의 석발", true), &img_mon_kaguya_quiz[1], 10, 0, 5,
	{ 0,0,0 },{ ATT_NONE,ATT_NONE,ATT_NONE },{ name_infor(),name_infor(),name_infor() },
		M_FLAG_NO_ATK | M_FLAG_NONE_MOVE | M_FLAG_PASSED_ALLY | M_FLAG_PASSED_ENEMY | M_FLAG_SILENCE | M_FLAG_FLY | M_FLAG_CANT_NETURAL | M_FLAG_INANIMATE, 99, 0, 10, '*' },

	{ MON_KAGUYA_QUIZ_2, 12, 1, name_infor("불쥐의 가죽옷", true), &img_mon_kaguya_quiz[2], 10, 0, 5,
	{ 0,0,0 },{ ATT_NONE,ATT_NONE,ATT_NONE },{ name_infor(),name_infor(),name_infor() },
		M_FLAG_NO_ATK | M_FLAG_NONE_MOVE | M_FLAG_PASSED_ALLY | M_FLAG_PASSED_ENEMY | M_FLAG_SILENCE | M_FLAG_FLY | M_FLAG_CANT_NETURAL | M_FLAG_INANIMATE, 99, 0, 10, '*' },

	{ MON_KAGUYA_QUIZ_3, 12, 1, name_infor("제비의 자안패", true), &img_mon_kaguya_quiz[3], 10, 0, 5,
	{ 0,0,0 },{ ATT_NONE,ATT_NONE,ATT_NONE },{ name_infor(),name_infor(),name_infor() },
		M_FLAG_NO_ATK | M_FLAG_NONE_MOVE | M_FLAG_PASSED_ALLY | M_FLAG_PASSED_ENEMY | M_FLAG_SILENCE | M_FLAG_FLY | M_FLAG_CANT_NETURAL | M_FLAG_INANIMATE, 99, 0, 10, '*' },
