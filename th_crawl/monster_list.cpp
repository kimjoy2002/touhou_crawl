...
const mon_infor mondata[] = {
	...
	{MON_CRANE,5,116,name_infor("두루미",false),&img_mons_crane,33,3,10,
	...
	{MON_BLACK_CAT,8,287,name_infor("검은고양이",false),&img_mons_black_cat,40,0,15,
	{10,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("할퀴기",false),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,7},
	
	{MON_ORANGE_CAT,8,287,name_infor("주황고양이",false),&img_mons_orange_cat,40,0,15,
	{10,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("할퀴기",false),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,7},

	{MON_WHITE_CAT,8,287,name_infor("하얀고양이",false),&img_mons_white_cat,40,0,15,
	{10,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("할퀴기",false),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,7},
	...
	{MON_ONI,14,912,name_infor("오니",false),&img_mons_oni,120,10,2,
	...
	{MON_REMILIAYUKKURI,14,1440,name_infor("윳쿠리레미랴",false),&img_mons_remila_yukkuri,60,5,12,
	...
	{MON_ALICEYUKKURI,11,960,name_infor("윳쿠리앨리스",false),&img_mons_alice_yukkuri,100,7,5,
	{18,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_SPEAK,1,0,15},

	{MON_YOUMUYUKKURI,11,960,name_infor("윳쿠리요우무",false),&img_mons_default,70,2,10,
	{18,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_KATPA_SPEAR,9,830,name_infor("캇파 창병",true),&img_mons_new_kappa_spear,70,5,10,
	...
	{MON_KATPA_WATER_WIZARD,10,960,name_infor("캇파 수술사",false),&img_mons_new_kappa_wizard,45,4,10,
	{4,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_BLUE_ONI,13,1412,name_infor("아오오니",false),&img_mons_blue_oni,120,10,2,
	{35,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_SPEAK,1,1,10},

	{MON_MUSHROOM,9,832,name_infor("버섯요괴",false),&img_mons_mushroom,50,6,0,
	...
	{MON_SIGMUND,3,154,name_infor("지그문트",false),&img_named_sigmund,30,0,11,
	{15,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_UNIQUE | M_FLAG_SPEAK,1,1,10},
	...
	{MON_MAID_FAIRY,7,171,name_infor("요정 메이드",false),&img_mons_maid_fairy,32,1,12,
	{7,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_OPEN_DOOR | M_FLAG_FAIRY | M_FLAG_SPEAK | M_FLAG_FLY,0,1,10},
	...
	{MON_DRAGON_BABY,12,1260,name_infor("용의 새끼",false),&img_mons_dragon_baby,90,0,6,
	...
	{MON_KASEN,14,4872,name_infor("카센",true),&img_named_kasen,150,5,6,
	...
	{MON_RED_UFO,12,1280,name_infor("레드 벤토라",false),&img_mons_red_ufo,95,5,10,
	{30,0,0},{ATT_FIRE,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_CAN_SEE_INVI | M_FLAG_FLY,1,1,9},
	
	{MON_GREEN_UFO,12,1280,name_infor("그린 벤토라",false),&img_mons_green_ufo,95,5,10,
	{30,0,0},{ATT_ELEC,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_CAN_SEE_INVI | M_FLAG_FLY,1,1,9},
		
	{MON_BLUE_UFO,12,1280,name_infor("블루 벤토라",false),&img_mons_blue_ufo,95,5,10,
	...
	M_FLAG_OPEN_DOOR | M_FLAG_CAN_SEE_INVI | M_FLAG_SPEAK | M_FLAG_FLY,2,1,10},		
	{MON_YUMEKO,16,5672,name_infor("유메코",false),&img_mons_yumeko,180,3,16,
	{30,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	...
	{MON_RABIT_BOMB,9,220,name_infor("토끼 자폭병",true),&img_mons_bomb_rabbit,12,1,20,
	{0,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL | M_FLAG_OPEN_DOOR | M_FLAG_SPEAK,0,1,9},
	
	{MON_RABIT_SPEAR,11,340,name_infor("토끼 죽창병",true),&img_mons_spear_rabbit,35,5,15,
	...
	{MON_FAIRY_HERO,1,1,name_infor("요정 영웅",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_FAIRY_SOCERER,1,1,name_infor("요정 정령술사",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_FAIRY_SUN_FLOWER,1,1,name_infor("해바라기 요정",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_MOON_RABIT_SUPPORT,1,1,name_infor("달토끼 지원병",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_MOON_RABIT_ATTACK,1,1,name_infor("달토끼 척후병",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},

	{MON_MOON_RABIT_ELITE,1,1,name_infor("달토끼 정예병",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_MAC,1,1,name_infor("맥",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_NIGHTMARE,1,1,name_infor("악몽의 조각",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_LUNATIC,1,1,name_infor("광기의 조각",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_HAUNT,1,1,name_infor("원령",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},

	{MON_FIRE_CAR,1,1,name_infor("화차",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_HELL_SPIDER,1,1,name_infor("츠지구모",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_BLOOD_HAUNT,1,1,name_infor("핏빛 원령",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_HELL_HOUND,1,1,name_infor("지옥개",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	...
	{MON_FLOWER_TANK,1,1,name_infor("플라워 전차",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_EVIL_EYE_TANK,1,1,name_infor("이블 아이 전차",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_SNOW_GIRL,1,1,name_infor("설녀",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_LETTY,1,1,name_infor("레티",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_YORIHIME,1,1,name_infor("요리히메",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},

	{MON_TOYOHIME,1,1,name_infor("토요히메",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_UTSUHO,1,1,name_infor("우츠호",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_SUIKA,1,1,name_infor("스이카",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_REIMU,1,1,name_infor("레이무",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_ALICE,1,1,name_infor("앨리스",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},

	{MON_SEIRAN,1,1,name_infor("세이란",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_RINGO,1,1,name_infor("링고",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_UDONGE,1,1,name_infor("레이센",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_KAGUYA,1,1,name_infor("카구야",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_MOKOU,1,1,name_infor("모코우",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_NESI,1,1,name_infor("네시",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_SANGHAI,1,1,name_infor("상해 인형",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10},
	
	{MON_HOURAI,1,1,name_infor("봉래 인형",false),&img_mons_default,10,0,6,
	{2,0,0},{ATT_NORMAL,ATT_NONE,ATT_NONE},{name_infor("공격",true),name_infor(),name_infor()},
	M_FLAG_ANIMAL,0,1,10}
