...
amulet_type goodbadamulet(int good_bad)
{
	...
	//if(good_bad>=0)
	//{
	//	amulet_type list_[4] = {AMT_AC, AMT_EV, AMT_CONFUSE_RESIS, AMT_POWER_KEEP};
	//	return list_[randA(3)];
	//}
	//else
	//{
	//	amulet_type list_[3] = {AMT_AC, AMT_EV, AMT_INACCURACY};
...
bool equipamulet(amulet_type kind, int value)
{
	...
	//	if(iden_list.amulet_list[kind].iden == 0)
	//		iden_list.amulet_list[kind].iden = 2;
	//	return true;
	//case AMT_EV:
	//	if(value>0)
	//		printlog("당신은 재빨라졌다.",true,false,false,CL_good);
	...
	//	if(iden_list.amulet_list[kind].iden == 0)
	//		iden_list.amulet_list[kind].iden = 1;
	//	return false;
	//case AMT_INACCURACY:
	//	you.acc_plus += -5*value;
	//	if(iden_list.amulet_list[kind].iden == 0)
	//		iden_list.amulet_list[kind].iden = 1;
	//	return false;
	//case AMT_POWER_KEEP:
...
bool unidenequipamulet(amulet_type kind, int value)
{
	...
	//{
	//case AMT_CONFUSE_RESIS:
	//	you.UnidenResistUpDown(value,RST_CONFUSE);
	//	return true;
	//case AMT_POWER_KEEP:
	//	you.UnidenResistUpDown(value,RST_POWER);
	//	return true;
