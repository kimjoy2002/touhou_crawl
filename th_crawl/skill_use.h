...
enum spell_list
{
	...
	SPL_TOUGUE,
	SPL_WINDFLAW,SPL_SUMMON_GHOST,SPL_MEGATON_KICK,SPL_THROW_OIL,SPL_HEAVENLY_STORM,
	SPL_TRACKING,SPL_DISCORD,SPL_SMOKING,SPL_CREATE_FOG,SPL_GROW_VINE,SPL_CLOSE_DOOR,SPL_SPEAKER_PHONE,
	SPL_HOMING_TANMAC,SPL_ALLROUND_TANMAC,
	SPL_THROW_POTION,SPL_THROW_RABBIT,
