...
string GetSkillInfor(skill_list skill)
{
	...
	case SKL_ABANDON_GOD:
		...
		break;
	case SKL_SEIJA_GIFT:
		text_ += "세이자가 다른 신들에게서 훔쳐온 보물을 선물로 받습니다.\n";
		text_ += "선택한 신의 훔쳐온 보물을 받는 대신에 선택한 신의 징벌상태가 됩니다.\n";
		text_ += "또한 세이자로부터의 신용을 조금씩 잃습니다. 선택한 신의 징벌이 끝나면 다시 받을 수 있습니다.\n";
		text_ += "이 권능은 일정 시간이 흐르면 자동으로 사라지면서 신앙심 또한 똑같이 감소하므로 아끼지맙시다.\n";
		break;
	default:
		text_ += "모르는 능력.\n";
		break;
